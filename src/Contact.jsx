       ...
       <div className="flex flex-col items-center justify-center gap-4">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                className={`p-2 rounded border ${
                    errors.name ? "border-red-500 bg-red-100" : "border-gray-400"
                  }`}/>
                ...
                className={`p-2 rounded border ${
                    errors.email ? "border-red-500 bg-red-100" : "border-gray-400"
                  }`}/>
                ...
                className={`p-2 rounded border ${
                    errors.message ? "border-red-500 bg-red-100" : "border-gray-400"
                  }`}>
                </textarea>
                ...
                <fieldset className="">
                    ...
                    <label htmlFor="conssent" className="text-sm">I agree to having this website store my submitted information so that they can respond.</label> 
                </div>
                    </fieldset>
                

                <button type="submit" className="bg-purple-600 text-white p-2 rounded hover:bg-purple-700 transition duration-300">Send</button>                
            </form>
            {formSubmitted && (
                <p className="mt-4 text-green-700 font-semibold">Thank you for your message. We will reach back soon!</p>
            )}
        </div>
